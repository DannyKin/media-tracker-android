...
--- I understood how to do the register screen and get the text boxes in the right place.
...
--- The ApiService is making the app not run at all. So I was wondering how do you fix that. 
